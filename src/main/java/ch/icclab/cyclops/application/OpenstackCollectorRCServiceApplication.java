...
import ch.icclab.cyclops.usecases.openstack.OpesntackCollectorRunner;
 ...
 */
public class OpenstackCollectorRCServiceApplication extends AbstractApplication {
    final static Logger logger = LogManager.getLogger(OpenstackCollectorRCServiceApplication.class.getName());
    ...
    private void scheduleTasks() {
        ...
        try {
            ...
            // add schedulers
            scheduler.addRunner(new OpesntackCollectorRunner(), 0, frequency, TimeUnit.SECONDS);
