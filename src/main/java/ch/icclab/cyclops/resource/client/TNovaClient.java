 ...
 * Description: This class handles the internal scheduler for TNova
 */
public class TNovaClient extends ServerResource {
    final static Logger logger = LogManager.getLogger(TNovaClient.class.getName());

    // We are going to be working with CloudStack scheduler here
    private static TNovaScheduler scheduler = TNovaScheduler.getInstance();
