 ...
 */
public class McnPuller {
    final static Logger logger = LogManager.getLogger(McnPuller.class.getName());
    ...
    public McnUDRResponse retrieveUsageResponseFromUDR() {
     ...
     */
    private McnUDRResponse parseResponse(String response) {
        Gson gson = new Gson();

        return gson.fromJson(response, McnUDRResponse.class);
    }
