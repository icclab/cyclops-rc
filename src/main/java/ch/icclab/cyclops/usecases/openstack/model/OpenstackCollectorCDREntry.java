 ...
 */
public class OpenstackCollectorCDREntry {
    private String name = "openstack_cdr";
    private String time;
     ...
     */
    public OpenstackCollectorCDREntry(UDREntry udr, BillingModel model, String clientId) {
        // basic header
