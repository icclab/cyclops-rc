...
public abstract class AbstractApplicationFactory {
    ...
    public static AbstractApplication getApplication(Context context) {
        try {
            ...
            AbstractApplicationFactory creator = (AbstractApplicationFactory) Class.forName(packagePath.concat(applicationClassName).concat("RCServiceApplicationFactory")).newInstance();
