...
import ch.icclab.cyclops.services.iaas.cloudstack.model.CDR;
 ...
 * Description: Access CloudStack charge records from influxDB
 */
public class ChargeResource extends ServerResource {
    ...
    public Representation getChargeRecords(){
        ...
        tsdbData = dbClient.getData("SELECT * FROM "+ CDR.getCDRColumnName()+" WHERE userId='"+userid+"' AND time > '"+fromDate+"' AND time < '"+toDate+"'");
